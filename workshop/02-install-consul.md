...
```bash
cd /root
git clone https://github.com/natilik/CLEU2024-DEVWKS-2712.git
```
...
```bash
cat /root/CLEU2024-DEVWKS-2712/deploy/grafana/values.yaml
```
...
```bash
helm install grafana grafana/grafana -f /root/CLEU2024-DEVWKS-2712/deploy/grafana/values.yaml
```
